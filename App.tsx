    ...
    <div className="min-h-screen bg-[#E3F2FD] font-sans pb-12">
      ...
      <footer className="mt-12 text-center text-blue-800/60 text-sm py-6">
        ...
        <p className="mt-2 font-bold text-blue-800">
          ĐĂNG KÝ KHOÁ HỌC THỰC CHIẾN VIẾT SKKN, TẠO APP DẠY HỌC, TẠO MÔ PHỎNG TRỰC QUAN CHỈ VỚI 1 CÂU LỆNH: <a href="https://forms.gle/d7AmcT9MTyGy7bJd8" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-600">https://tinyurl.com/khoahocAI2025</a>
        </p>
